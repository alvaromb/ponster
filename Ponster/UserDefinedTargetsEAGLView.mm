...
@interface UserDefinedTargetsEAGLView (PrivateMethods)
...
@implementation UserDefinedTargetsEAGLView
...
- (void) setRefFreeFrame: (RefFreeFrame *) rFreeFrame {
    refFreeFrame = rFreeFrame;
