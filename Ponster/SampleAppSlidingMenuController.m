...
//    bounds.origin.y += 44;
    ...
    self.panGestureRecognizer = [[[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(panGestureAction:)] autorelease];
    self.panGestureRecognizer.delegate = (id<UIGestureRecognizerDelegate>)self;
    ...
    self.tapGestureRecognizer = [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapGestureAction:)] autorelease];
    self.tapGestureRecognizer.delegate = (id<UIGestureRecognizerDelegate>)self;
    [self.view addGestureRecognizer:self.tapGestureRecognizer];
    [self.tapGestureRecognizer setEnabled:NO];
    if (doubleTap != NULL) {
        [self.tapGestureRecognizer requireGestureRecognizerToFail:doubleTap];
    }
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    return (self.tapGestureRecognizer == gestureRecognizer);
}
