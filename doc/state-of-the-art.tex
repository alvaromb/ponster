...
scene[cita aqui]. We call nature feature to any point or region candidate to be
detected and selected as a reference. Usually this follows the next steps:
\begin{itemize}
...
estimation can be executed by several ways. For example, in [paper], optical
