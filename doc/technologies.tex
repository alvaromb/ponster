...
\subsection{OpenCV}
OpenCV is an open source computer vision library\ref{opencv}. The library has
...
build\ref{opencvpod}. Some of the algorithms used in Ponster --like SURF or SIFT--
